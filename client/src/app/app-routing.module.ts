...
import { ClientiListComponent} from './pages/clienti-list/clienti-list.component';
...
const routes: Routes = [
    ...
    { path: 'clientis',  loadChildren: './pages/clienti-list/clienti-list.module#ClientiListModule' , canActivate: [AuthGuard] },
